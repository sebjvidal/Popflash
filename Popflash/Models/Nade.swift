...
extension Nade {
    static let empty = Nade(documentID: "", id: "", name: "", map: "", type: "", side: "", thumbnail: "", video: "", lineup: "", shortDescription: "", longDescription: "", views: 0, favourites: 0, bind: "", tick: "", tags: [], dateAdded: 0, compliments: [], warning: "", section: "Today")
