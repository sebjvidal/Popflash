...
class MapCollectionViewCoordinator: NSObject, UICollectionViewDelegate, UICollectionViewDragDelegate, UICollectionViewDropDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "FavouriteMapCell", for: indexPath) as? FavouriteMapCollectionViewCell else {
...
class FavouriteMapCollectionViewCell: UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        iconImage.frame = CGRect(x: (cellWidth / 2) - 40, y: ((cellWidth / 2) * 1.5) - 40, width: 80, height: 80)
