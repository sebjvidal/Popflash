...
class RecentlyViewedViewModel: ObservableObject {
    ...
    private func section(dateAdded: Double) -> String {
        let dateBounds: [(title: String, bound: Date)] = [
            ...
            (title: "Last Week", bound: date(subtracting: 7)),
            (title: "Last Month", bound: date(subtracting: 30)),
            (title: "Last 3 Months", bound: date(subtracting: 91)),
            (title: "Last 6 Months", bound: date(subtracting: 182)),
            (title: "Last Year", bound: date(subtracting: 365))
        ]
